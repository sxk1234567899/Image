/********************************************************************************
** Form generated from reading UI file 'wgtregno1.ui'
**
...
#ifndef UI_WGTREGNO1_H
#define UI_WGTREGNO1_H
...
public:
    ...
    void setupUi(QWidget *WgtRegNo1Class)
    {
        if (WgtRegNo1Class->objectName().isEmpty())
            WgtRegNo1Class->setObjectName("WgtRegNo1Class");
        WgtRegNo1Class->resize(1280, 690);
        WgtRegNo1Class->setMinimumSize(QSize(0, 0));
        WgtRegNo1Class->setMaximumSize(QSize(16777215, 16777215));
        gridLayout = new QGridLayout(WgtRegNo1Class);
        ...
        widgetTool = new QWidget(WgtRegNo1Class);
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/image/switch.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        pushButtonGoReg2 = new QPushButton(widgetTool);
        pushButtonGoReg2->setObjectName("pushButtonGoReg2");
        pushButtonGoReg2->setMinimumSize(QSize(300, 70));

        horizontalLayout->addWidget(pushButtonGoReg2);
        ...
        stackedWidget = new QStackedWidget(WgtRegNo1Class);
        ...
        scrollArea = new QScrollArea(WgtRegNo1Class);
        scrollArea->setObjectName("scrollArea");
        scrollArea->setWidgetResizable(true);
        scrollAreaWidgetContents_2 = new QWidget();
        scrollAreaWidgetContents_2->setObjectName("scrollAreaWidgetContents_2");
        scrollAreaWidgetContents_2->setGeometry(QRect(0, -272, 621, 870));
        ...
        label_14->setMinimumSize(QSize(90, 50));
        ...
        lineEditName->setMinimumSize(QSize(0, 50));
        lineEditName->setMaximumSize(QSize(16777215, 50));
        ...
        label_17->setMinimumSize(QSize(90, 50));
        ...
        lineEditSize->setMinimumSize(QSize(0, 50));
        lineEditSize->setMaximumSize(QSize(16777215, 50));
        ...
        label_16->setMinimumSize(QSize(90, 50));
        ...
        lineEditTexture->setMinimumSize(QSize(0, 50));
        lineEditTexture->setMaximumSize(QSize(16777215, 50));
        ...
        label_18->setMinimumSize(QSize(90, 50));
        ...
        lineEditAge->setMinimumSize(QSize(0, 50));
        lineEditAge->setMaximumSize(QSize(16777215, 50));
        ...
        label_15->setMinimumSize(QSize(90, 50));
        ...
        lineEditLevel->setMinimumSize(QSize(0, 50));
        lineEditLevel->setMaximumSize(QSize(16777215, 50));
        ...
        label_21->setMinimumSize(QSize(90, 50));
        ...
        lineEditCarrier->setMinimumSize(QSize(0, 50));
        lineEditCarrier->setMaximumSize(QSize(16777215, 50));
        ...
        label_22->setMinimumSize(QSize(90, 50));
        ...
        lineEditApplicant->setMinimumSize(QSize(0, 50));
        lineEditApplicant->setMaximumSize(QSize(16777215, 50));
        ...
        lineEditDept->setMinimumSize(QSize(0, 50));
        lineEditDept->setMaximumSize(QSize(16777215, 50));
        ...
        labelExhibitionTitle->setMinimumSize(QSize(90, 50));
        labelExhibitionTitle->setMaximumSize(QSize(16777215, 50));
        ...
        lineEditExhibitionTitle->setMinimumSize(QSize(0, 50));
        lineEditExhibitionTitle->setMaximumSize(QSize(16777215, 50));
        ...
        retranslateUi(WgtRegNo1Class);

        stackedWidget->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(WgtRegNo1Class);
    } // setupUi

    void retranslateUi(QWidget *WgtRegNo1Class)
    {
        WgtRegNo1Class->setWindowTitle(QCoreApplication::translate("WgtRegNo1Class", "WgtRegNo1", nullptr));
        pushButtonMode->setText(QCoreApplication::translate("WgtRegNo1Class", "    \345\210\227\350\241\250\346\250\241\345\274\217  ", nullptr));
        pushButtonSCode->setText(QCoreApplication::translate("WgtRegNo1Class", "\346\211\253\344\270\200\346\211\253", nullptr));
        pushButtonGoReg2->setText(QCoreApplication::translate("WgtRegNo1Class", "\345\274\200\345\247\213\346\213\215\345\233\276", nullptr));
        labelCode2d->setText(QString());
        labelInfo->setText(QCoreApplication::translate("WgtRegNo1Class", "\350\257\267\346\202\250\346\211\253\346\217\217\351\234\200\350\246\201\347\231\273\350\256\260\347\211\251\347\232\204\344\272\214\347\273\264\347\240\201\357\274\214\n"
"\346\211\253\347\247\222\345\256\214\346\210\220\345\220\216\345\260\206\346\230\276\347\244\272\345\237\272\346\234\254\344\277\241\346\201\257\343\200\202", nullptr));
        plainTextEdit->setPlaceholderText(QCoreApplication::translate("WgtRegNo1Class", "\346\211\253\346\217\217\350\257\206\345\210\253\345\214\272", nullptr));
        toolButtonBatchUpPage->setText(QString());
        labelBatchPage->setText(QCoreApplication::translate("WgtRegNo1Class", "TextLabel", nullptr));
        toolButtonBatchNextPage->setText(QCoreApplication::translate("WgtRegNo1Class", "...", nullptr));
        toolButtonListUpPage->setText(QCoreApplication::translate("WgtRegNo1Class", "...", nullptr));
        labelListPage->setText(QCoreApplication::translate("WgtRegNo1Class", "1/20", nullptr));
        toolButtonListNextPage->setText(QCoreApplication::translate("WgtRegNo1Class", "...", nullptr));
        labelImage->setText(QString());
        label_14->setText(QCoreApplication::translate("WgtRegNo1Class", "\345\220\215   \347\247\260", nullptr));
        lineEditName->setPlaceholderText(QString());
        label_17->setText(QCoreApplication::translate("WgtRegNo1Class", "\345\260\272   \345\257\270", nullptr));
        lineEditSize->setPlaceholderText(QString());
        label_16->setText(QCoreApplication::translate("WgtRegNo1Class", "\350\264\250   \345\234\260", nullptr));
        lineEditTexture->setPlaceholderText(QString());
        label_18->setText(QCoreApplication::translate("WgtRegNo1Class", "\345\271\264   \344\273\243", nullptr));
        lineEditAge->setPlaceholderText(QString());
        label_15->setText(QCoreApplication::translate("WgtRegNo1Class", "\347\272\247   \345\210\253", nullptr));
        lineEditLevel->setPlaceholderText(QString());
        label_21->setText(QCoreApplication::translate("WgtRegNo1Class", "\345\215\217\350\277\220\344\272\272", nullptr));
        lineEditCarrier->setPlaceholderText(QString());
        label_22->setText(QCoreApplication::translate("WgtRegNo1Class", "\347\224\263\350\257\267\344\272\272", nullptr));
        lineEditApplicant->setPlaceholderText(QString());
        label_12->setText(QCoreApplication::translate("WgtRegNo1Class", "\350\256\276   \345\244\207", nullptr));
        lineEditDept->setPlaceholderText(QString());
        label_13->setText(QCoreApplication::translate("WgtRegNo1Class", "\345\233\276   \347\211\207", nullptr));
        labelExhibitionTitle->setText(QCoreApplication::translate("WgtRegNo1Class", "\345\261\225\350\247\210\345\220\215", nullptr));
...
namespace Ui {
    class WgtRegNo1Class: public Ui_WgtRegNo1Class {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_WGTREGNO1_H
